...
export default function CatForm(props) {
    const handleSubmit = (values) => {
        ...
        if(!props.category){
            ...
            axios.post(`https://localhost:7026/api/Categories`, catToCreate).then(() => {
        ...
        else
        {
            ...
            axios.put(`https://localhost:7026/api/Categories/${props.category.categoryId}`, catToEdit).then(() => {
    ...
    return (
        <div className='createCategory m-2 text-white text-center'>
            <Formik
                ...
                {({ errors, touched }) => (
                    <Form id='catForm' className='row text-center  offset-4'>
                        <div className='form-group m-1 p-1 col-6'>
